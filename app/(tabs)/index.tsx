...
const styles = StyleSheet.create({
  ...
  sectionHead: { flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: theme.color.outlineVariant, paddingBottom: 9, marginBottom: 10 }, sectionTitle: { fontFamily: theme.font.headlineSemi, fontSize: 22, color: theme.color.onSurface },
